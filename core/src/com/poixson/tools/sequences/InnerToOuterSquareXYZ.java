...
public class InnerToOuterSquareXYZ implements Iterator<Iabc> {
	...
	public final InnerToOuterSquareXZ it_xz;
	public final AtomicInteger index = new AtomicInteger(0);



	public InnerToOuterSquareXYZ(final int size_xz, final int size_y) {
		this.it_xz = new InnerToOuterSquareXZ(size_xz);
